...
impl Scancode {
    ...
    pub fn from_u8(b: u8) -> Option<Self> {
        Some(match b {
            ...
            0x2E => Self::Equals,
            0x2F => Self::LeftBrace,
            0x30 => Self::RightBrace,
            0x31 => Self::Backslash,
            0x32 => Self::NonUsHash,
            0x33 => Self::Semicolon,
            0x34 => Self::Apostrophe,
            0x35 => Self::Grave,
            0x36 => Self::Comma,
            0x37 => Self::Period,
            0x38 => Self::Slash,
            ...
            0x51 => Self::Down,
            0x52 => Self::Up,
            0x53 => Self::NumLockClear,
            0x54 => Self::KpDivide,
            0x55 => Self::KpMultiply,
            0x56 => Self::KpMinus,
            0x57 => Self::KpPlus,
            0x58 => Self::KpEnter,
            0x59 => Self::Kp1,
...
const DPAD_MASK: u32 = GamepadButton::DpadUp as u32
...
mod tests {
    ...
    fn dpad_table() {
        ...
        assert_eq!(
            dpad_hat_value(GamepadButton::DpadUp as u32 | GamepadButton::DpadLeft as u32),
            8
        );
        assert_eq!(
            dpad_hat_value(GamepadButton::DpadDown as u32 | GamepadButton::DpadRight as u32),
            4
        );
    }
